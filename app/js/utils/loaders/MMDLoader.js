...
THREE.MMDLoader.prototype.createMesh = function ( model, texturePath, onProgress, onError ) {
	...
	var initGeometry = function () {
		...
		geometry.addAttribute( 'skinIndex', THREE.Float32BufferAttribute( buffer.skinIndices, 4 ) );
		geometry.addAttribute( 'skinWeight', THREE.Float32BufferAttribute( buffer.skinWeights, 4 ) );
